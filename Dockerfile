...
RUN apt-get update && apt-get install -y curl libpq-dev gcc python-dev supervisor nginx openjdk-11-jdk p7zip mediainfo && \
  ...
  useradd -u 55020 -g 55020 -G 4000,4177 --create-home appuser
...
COPY --chown=appuser etdtestceleryconfig.py /home/appuser/etdtestceleryconfig.py
